//Variables para el objeto XMLHttpRequest
var solicitudAsinc;
...
function registrarManejadores() {
    ...
    //Creando el contenido y borrándolos all producirse los eventos
...
function obtenerContenido(id) {
    ...
    const URL = "https://69f37261bd2396bf53100336.mockapi.io/api/example/books/" + id;
    try {
        //Crear objeto petición XMLHttpRequest
        //Cambiar esto por una función multinavegador para construir el objeto XMLHttpRequest
